...
char default_layout_names[LAYERS][MAX_LAYOUT_NAME_LENGTH] = { "DVORAK", "EXTRA",
		  "QWERTY",
		};
...
uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	{K_ESC,  K_ENT,/**/	K_2,    	K_3,    	K_4,    	K_5,    K_6,    	K_7,    K_8,    K_9,/**/  TO_L3,		K_INT3,    /**/K_LBRC },
	{K_DEL,  K_1,    		K_COMM,    K_DOT,  	K_P,    	K_Y,    K_F,    	K_G,    K_C,    K_R,   K_0,    	K_EQUAL,    /**/MO_L2},
	{K_TAB,  K_QUOT,    	K_O,    	K_E,    	K_U, 		K_I,    K_D,    	K_H,    K_T,    K_N,   K_L, 	K_SLSH,     /**/K_RBRC},
	{K_RALT, K_A,    		K_Q,    	K_J,   	K_K, 		K_X,    K_B,    	K_M,    K_W,    K_V,   K_S, 	K_MINUS,     /**/K_RSHIFT},
	...
	},
   {
	...
	{K_NO,  K_NO,    K_NO,    MACRO_1,    MACRO_2,    K_NO,    K_NO,    K_NO,    K_NO,    K_NO,    K_NO,           K_NO, K_NO} ,
